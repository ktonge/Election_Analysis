...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_options:
        ...
        county_results= (
            f"{county_name}: {county_vote_percentage:.1f}% turnout, {total_county_votes} total votes\n")
        print(county_results)
         # 6e: Save the county votes to a text file.
        txt_file.write(county_results)
         # 6f: Write an if statement to determine the winning county and get its vote count.
        if (total_county_votes>largest_voter_turnout):
            largest_county=county_name
            largest_voter_turnout=total_county_votes
    
    # 7: Print the county with the largest turnout to the terminal.
    largest_county_results = (
        f"\nLargest Voter Turnout\n"
        f"-------------------------\n"
        f"{largest_county}: {largest_voter_turnout}\n"
        f"-------------------------\n\n")
